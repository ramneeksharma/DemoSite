...
INSERT INTO MYCATEGORYIMPL SELECT CATEGORY_ID FROM BLC_CATEGORY;
...
INSERT INTO MYSEARCHFACETIMPL select SEARCH_FACET_ID from BLC_SEARCH_FACET;
------------------------------------------------------------------------------------------------------------------
...
insert into myproductoptionimpl(PRODUCT_OPTION_ID) select PRODUCT_OPTION_ID from BLC_PRODUCT_OPTION ;
...
INSERT INTO myproductoptionvalueimpl(PRODUCT_OPTION_VALUE_ID) SELECT PRODUCT_OPTION_VALUE_ID FROM BLC_PRODUCT_OPTION_VALUE ; 
...
INSERT INTO MYSKUIMPL  select SKU_ID from BLC_SKU;
INSERT INTO MYFULFILLMENTOPTIONIMPL SELECT FULFILLMENT_OPTION_ID FROM BLC_FULFILLMENT_OPTION;