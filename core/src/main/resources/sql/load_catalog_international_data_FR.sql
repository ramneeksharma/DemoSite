...
INSERT INTO BLC_CATEGORY_TR (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (2001,'Page d''accueil','Page d''accueil');
INSERT INTO BLC_CATEGORY_TR (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (2002,'Sauces chaudes','Sauces chaudes');
INSERT INTO BLC_CATEGORY_TR (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (2003,'Marchandises','Marchandises');
INSERT INTO BLC_CATEGORY_TR (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (2004,'D&eacute;gagement','D&eacute;gagement');
INSERT INTO BLC_CATEGORY_TR (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (2005,'Nouveau Hot Sauce?','Nouveau Hot Sauce?');
INSERT INTO BLC_CATEGORY_TR (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (2006,'FAQ','FAQ');

-- Custom store SKU cross reference with translations
INSERT INTO BLC_CATEGORY_TRXREF (CATEGORY_ID, TRANSLATION_ID, MAP_KEY) VALUES (2001, 2001, 'fr');
INSERT INTO BLC_CATEGORY_TRXREF (CATEGORY_ID, TRANSLATION_ID, MAP_KEY) VALUES (2002, 2002, 'fr');
INSERT INTO BLC_CATEGORY_TRXREF (CATEGORY_ID, TRANSLATION_ID, MAP_KEY) VALUES (2003, 2003, 'fr');
INSERT INTO BLC_CATEGORY_TRXREF (CATEGORY_ID, TRANSLATION_ID, MAP_KEY) VALUES (2004, 2004, 'fr');
INSERT INTO BLC_CATEGORY_TRXREF (CATEGORY_ID, TRANSLATION_ID, MAP_KEY) VALUES (2005, 2005, 'fr');
INSERT INTO BLC_CATEGORY_TRXREF (CATEGORY_ID, TRANSLATION_ID, MAP_KEY) VALUES (2006, 2006, 'fr');
...
INSERT INTO BLC_PRODUCT_OPTION_TR (TRANSLATION_ID,LABEL) VALUES (2001,'Shirt Couleur');
INSERT INTO BLC_PRODUCT_OPTION_TR (TRANSLATION_ID,LABEL) VALUES (2002,'Shirt Taille');

-- Custom store product options cross reference with translations
INSERT INTO BLC_PRODUCT_OPTION_TRXREF (PRODUCT_OPTION_ID, TRANSLATION_ID, MAP_KEY) VALUES (1, 2001, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_TRXREF (PRODUCT_OPTION_ID, TRANSLATION_ID, MAP_KEY) VALUES (2, 2002, 'fr');

-----------------------------------------------------------------------------------------------------------------------------------
-- PRODUCT OPTION VALUES TRANSLATION
-----------------------------------------------------------------------------------------------------------------------------------
-- Custom store product option values in French
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2001,'Noir');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2002,'Rouge');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2003,'Argent');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2011,'P');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2012,'M');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2013,'G');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TR (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (2014,'XG');

-- Custom store product option values cross reference with translations
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (1, 2001, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (2, 2002, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (3, 2003, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (11, 2011, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (12, 2012, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (13, 2013, 'fr');
INSERT INTO BLC_PRODUCT_OPTION_VAL_TRXREF (PRODUCT_OPTION_VALUE_ID, TRANSLATION_ID, MAP_KEY) VALUES (14, 2014, 'fr');
...
-----------------------------------------------------------------------------------------------------------------------------------
-- Custom store product options in French
INSERT INTO BLC_FULFILLMENT_OPTION_TR (TRANSLATION_ID,NAME,LONG_DESCRIPTION) VALUES (2001,'First Class', '2 - 7 Journ&eacute;es');
INSERT INTO BLC_FULFILLMENT_OPTION_TR (TRANSLATION_ID,NAME,LONG_DESCRIPTION) VALUES (2002,'Priorit&eacute;', '2 - 5 Journ&eacute;es');
INSERT INTO BLC_FULFILLMENT_OPTION_TR (TRANSLATION_ID,NAME,LONG_DESCRIPTION) VALUES (2003,'Express', '1 - 2 Journ&eacute;es');

-- Custom store product options cross reference with translations
INSERT INTO BLC_FULFILLMENT_OPTION_TRXREF (FULFILLMENT_OPTION_ID, TRANSLATION_ID, MAP_KEY) VALUES (1, 2001, 'fr');
INSERT INTO BLC_FULFILLMENT_OPTION_TRXREF (FULFILLMENT_OPTION_ID, TRANSLATION_ID, MAP_KEY) VALUES (2, 2002, 'fr');
INSERT INTO BLC_FULFILLMENT_OPTION_TRXREF (FULFILLMENT_OPTION_ID, TRANSLATION_ID, MAP_KEY) VALUES (3, 2003, 'fr');

-----------------------------------------------------------------------------------------------------------------------------------
-- SEARCH FACET TRANSLATION
-----------------------------------------------------------------------------------------------------------------------------------
-- Search facet in French
INSERT INTO BLC_SEARCH_FACET_TR (TRANSLATION_ID,LABEL) VALUES (2001,'Fabricant');
INSERT INTO BLC_SEARCH_FACET_TR (TRANSLATION_ID,LABEL) VALUES (2002,'Degr&eacute; de chaleur');
INSERT INTO BLC_SEARCH_FACET_TR (TRANSLATION_ID,LABEL) VALUES (2003,'Prix');

-- Search facet cross reference with translations
INSERT INTO BLC_SEARCH_FACET_TRXREF (SEARCH_FACET_ID, TRANSLATION_ID, MAP_KEY) VALUES (1, 2001, 'fr');
INSERT INTO BLC_SEARCH_FACET_TRXREF (SEARCH_FACET_ID, TRANSLATION_ID, MAP_KEY) VALUES (2, 2002, 'fr');
INSERT INTO BLC_SEARCH_FACET_TRXREF (SEARCH_FACET_ID, TRANSLATION_ID, MAP_KEY) VALUES (3, 2003, 'fr');